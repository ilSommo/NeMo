...
from nemo_text_processing.text_normalization.it.graph_utils import cardinal_separator
...
class CardinalFst(GraphFst):
    ...
    def __init__(self, deterministic: bool = True):
        ...
        graph_hundreds |= (
            pynini.cross("1", "cento") + insert_space + pynini.union(graph_tens, pynutil.delete("0") + graph_digit)
        )
        ...
        graph_trillion = pynutil.add_weight(pynini.cross("000001", "un bilione"), -0.001)
        graph_trillion |= graph_thousands_component_at_least_one_none_zero_digit_no_one + pynutil.insert(" bilioni")
