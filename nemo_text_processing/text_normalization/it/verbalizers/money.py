...
from nemo_text_processing.text_normalization.it.graph_utils import shift_cardinal_gender, strip_cardinal_apocope
...
class MoneyFst(GraphFst):
    ...
    def __init__(self, decimal: GraphFst, deterministic: bool = True):
        ...
        optional_add_and = pynini.closure(pynutil.insert(pynini.union("con ", "e ")), 0, 1)
