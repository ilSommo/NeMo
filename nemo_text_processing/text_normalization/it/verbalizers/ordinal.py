...
from nemo_text_processing.text_normalization.it.graph_utils import shift_number_gender
    ...
    def __init__(self, deterministic: bool = True):
        ...
        if not deterministic:
            ...
            graph_plural = pynini.cdrewrite(
                pynutil.insert("i"), pynini.union("o", "a"), NEMO_SPACE | pynini.accep("[EOS]"), NEMO_SIGMA
            )
